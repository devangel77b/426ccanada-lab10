...
\author{Tushaar Akula, Miguel Arenas, Cole Canada, Daivik Jajoo, Anton Lavrenov, and Timur Neyir\thanks{Author for correspondence: 226ccanada@frhsd.com}\thanks{Authors are with the Science \& Engineering Magnet Program, Manalapan High School, 20 Church Lane, Englishtown, NJ 07726, USA}}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.5\columnwidth]{new_experimental_procedure_illustration}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.8\columnwidth]{new_voltage_vs_distance.png}
\end{center}
...
\begin{tabular}{ccc}
\toprule
Distance (\unit{\centi\meter}) & Expected Voltage (\unit{\volt}) & Found Voltage (\unit{\volt}) \\
\midrule
0.0   & 0.0 & 0.00 \\
1.0   & 1.8 & 1.69 \\
2.0   & 2.9 & 2.84 \\
...
\begin{tabular}{ccc}
\toprule
Distance (\unit{\centi\meter}) & Region & Found Voltage (\unit{\volt}) \\
\midrule
0.0 & Electrode    & 0.00 \\
1.0 & Intact       & 0.31 \\
2.0 & Start of gap & 0.42 \\
2.5 & Mid-gap      & 3.51 \\
3.0 & End of gap   & 8.30 \\
4.0 & Intact       & 8.59 \\
5.0 & Electrode    & 9.00 \\
...
Since the voltages had noticeable discrepancies at corresponding locations between the uniform block and the non-uniform block (Fig. 2), we successfully showed a non-destructive testing method using measurements of electric voltage to reveal defects in conductive materials.

\section{Acknowledgement}

Thank you to Tushaar Akula, Miguel Arenas, Cole Canada, Daivik Jajoo, Anton Lavrenov, and Timur Neyir for working on this lab. Furthermore, thank you Dr.\ E and all former examples for guiding us throughout this lab.
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{tushaar.jpg}}]{Tushaar Akula}
is a student in the Science and Engineering Magnet Program at Manalapan High School.
\end{IEEEbiography}

\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{miguel.jpg}}]{Miguel Arenas} is a student in the Science and Engineering Magnet Program at Manalapan High School.
\end{IEEEbiography}

\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{canada.jpg}}]{Cole Canada} is a student in the Science and Engineering Magnet Program at Manalapan High School.
\end{IEEEbiography}

\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{daivik.jpg}}]{Daivik Jajoo} is a student in the Science and Engineering Magnet Program at Manalapan High School.
\end{IEEEbiography}

\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{anton.jpg}}]{Anton Lavrenov} is a student in the Science and Engineering Magnet Program at Manalapan High School.
\end{IEEEbiography}

\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{timur.jpg}}]{Timur Neyir} is a student in the Science and Engineering Magnet Program at Manalapan High School.
\end{IEEEbiography}
