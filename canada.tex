...
\IEEEPARstart{N}{on-destructive} testing (NDT) methods are critical for evaluating the reliability of electrical components without damaging them, starting with the testing of the components’ materials and metallic surfaces. In this experiment, an electric current flowed through a conductive medium, and electric potential was measured. Defects were mimicked on the medium, and the electric potential was measured again and compared. This study demonstrates how electrical measurements can reveal flaws without damaging the material.
